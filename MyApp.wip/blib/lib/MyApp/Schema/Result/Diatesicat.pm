use utf8;
package MyApp::Schema::Result::Diatesicat;
...
=head1 TABLE: C<DiatesiCat>

=cut

__PACKAGE__->table("DiatesiCat");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YutourDfj3PWgFzcBpOSHw
