...
//LOOP PARAS
$FILTER_PARA=(isset($argv[5]))?" AND start IN(".$argv[5].")":"";
$queryParas="
...
/////////  OUT ///////////////////
    ...
    $para_header = "\n\n".$SEP3.
              " START=".$para_start.
              " END=".$para_end .$SEP3;
    file_put_contents( "./alignment_res.txt", $para_header, FILE_APPEND | LOCK_EX ); 
...
//            $grSentsContents[]=$grRow['sent_gr'];
        ...
        file_put_contents( "./alignment_res.txt", $gr_header.$SEP1.implode(PHP_EOL,$grSentsContents), FILE_APPEND | LOCK_EX );
    }
